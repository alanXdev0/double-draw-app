export const TRANSLATIONS = {
  es: {
    ...
    tab_guide: "📖 Guía y FAQ",
    footer_text: "Duo Raffle • Desarrollado por Alan Anaya Araujo 🎯",
    support_title: "¿Te sirvió Duo Raffle?",
    support_description: "Invítame un café y ayúdame a seguir mejorando la experiencia.",
    support_button: "Apoyar el proyecto",
    support_pending: "Próximamente",
    completion_title: "Los equipos han sido asignados",
    completion_description: "Así quedó el sorteo de {pot}.",
    completion_person: "Participante",
    completion_team: "Equipo asignado",
    completion_export_text: "Exportar texto",
    completion_export_pdf: "Exportar PDF",
    completion_exporting_pdf: "Generando PDF...",
    completion_close: "Cerrar",
  ...
  en: {
    ...
    support_title: "Enjoying Duo Raffle?",
    support_description: "Buy me a coffee and help keep the experience improving.",
    support_button: "Support the project",
    support_pending: "Coming soon",
    completion_title: "The teams have been assigned",
    completion_description: "Here is how {pot} was assigned.",
    completion_person: "Participant",
    completion_team: "Assigned team",
    completion_export_text: "Export text",
    completion_export_pdf: "Export PDF",
    completion_exporting_pdf: "Generating PDF...",
